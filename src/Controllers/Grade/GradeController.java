...
public class GradeController implements Initializable {
    ...
    public void Back_Pressed(ActionEvent actionEvent) throws IOException {
        ...
        Parent root;
        if (ClientSocket.getInstance().getUser().getRole().equals(Roles.Admin))
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for (Grade grade :
                entities) {
            TableGrade tableGrade = new TableGrade(produces.get(i).getId(), produces.get(i).getName(), String.valueOf(grade.checkStrength()), String.valueOf(grade.checkWeight()), String.valueOf(String.valueOf(grade.checkSize())), String.valueOf(grade.checkThickness()), String.valueOf(grade.checkAppearance()), String.valueOf(grade.getResult()));
            list.add(tableGrade);
            i++;
        }
    ...
    public void Report_Pressed(ActionEvent actionEvent) throws IOException {
        ...
        for (Grade grade :
                entities) {
            String string = "";
            string += produces.get(i).getId() + " | " + produces.get(i).getName() + " | " + String.valueOf(grade.checkStrength()) + " | " + String.valueOf(grade.checkWeight()) + " | " + String.valueOf(String.valueOf(grade.checkSize())) + " | " + String.valueOf(grade.checkThickness()) + " | " + String.valueOf(grade.checkAppearance()) + " | " + String.valueOf(grade.getResult())+"\n";
