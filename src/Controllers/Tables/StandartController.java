    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (standarts.size() != 0 && standarts != null)
            for (Standart standart :
                    standarts) {
                TableStandart tableStandart = new TableStandart(standart.getId(), standart.getName(), standart.getStrength(), standart.getWeight(), standart.getSize(), standart.getThickness(), standart.getAppearance());
